...
export const loadedBack: LoadedAttribute[] = [
    ...
    {
        name: 'Garm',
        image: require(`./img/assets/Back/Garm.png`),
    },
    {
        name: 'Hawaiian Shirt',
    ...
    {
        name: 'Magic Cloth',
        image: require(`./img/assets/Back/Magic Cloth.png`),
    },
    {
        name: 'None',
        image: require(`./img/assets/Back/No Back.png`),
...
export const loadedBackgrounds: LoadedAttribute[] = [
    ...
    {
        name: 'Cum Slug',
        image: require(`./img/assets/Background/CumBackground.png`),
    },
    {
        name: 'Disco',
    ...
    {
        name: 'Pyramid',
        image: require(`./img/assets/Background/Pyramid.png`),
    },
    {
        name: 'Radioactive',
    ...
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Background/SantaBackground.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Background/SaviorBackground.png`),
    },
    {
        name: 'Sea Slug',
    ...
    {
        name: 'Temple',
        image: require(`./img/assets/Background/Temple.png`),
    },
    {
        name: 'Zombie',
...
export const loadedChest: LoadedAttribute[] = [
    ...
    {
        name: 'Chains and Nips',
        image: require(`./img/assets/Chest/Chains and Nips.png`),
    },
    {
        name: 'Cum Slug',
    ...
    {
        name: 'Dao',
        image: require(`./img/assets/Chest/Dao.png`),
    },
    {
        name: 'Demon Skeleton',
    ...
    },
    {
        ...
        image: require(`./img/assets/Chest/Golden Breastplate.png`),
    },
    {
        name: 'Half and Half',
        image: require(`./img/assets/Chest/Half and Half.png`),
    },
    {
        name: 'Jean Jacket',
    ...
    {
        name: 'Jeweled Crest',
        image: require(`./img/assets/Chest/Jeweled Crest.png`),
    },
    {
        name: 'Monstrosity',
    ...
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Chest/SantaChest.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Chest/SaviorChest.png`),
    },
    {
        name: 'Scarf',
...
export const loadedEyes: LoadedAttribute[] = [
    {
        name: 'All Seeing Eye',
        image: require(`./img/assets/Eyes/All seeing.png`),
    },
    {
        name: 'Capy',
    ...
    {
        name: 'Cum Slug',
        image: require(`./img/assets/Eyes/CumEyes.png`),
    },
    {
        name: 'Creepy',
    ...
    {
        name: 'Eyebrows',
        image: require(`./img/assets/Eyes/Eyebrow.png`),
    },
    {
    ...
    {
        name: 'It Burns',
        image: require(`./img/assets/Eyes/It burns.png`),
    },
    {
        name: 'KEKW',
    ...
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Eyes/SantaEyes.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Eyes/SaviorEye.png`),
    },
    {
        name: 'Shit',
    ...
    {
        name: 'Three Eyes',
        image: require(`./img/assets/Eyes/Three Eyes.png`),
    },
    {
        name: 'Uninterested',
...
export const loadedHands: LoadedAttribute[] = [
    ...
    {
        name: 'Crook',
        image: require(`./img/assets/Hands/Crook.png`),
    },
    {
        name: 'Cum Slug',
        image: require(`./img/assets/Hands/CumHands.png`),
    },
    {
        name: 'Decaying Grasp',
        image: require(`./img/assets/Hands/Decaying Grasp.png`),
    },
    {
        name: 'Demon Orb',
    ...
    {
        name: 'Flaming Sword',
        image: require(`./img/assets/Hands/Flaming Sword.png`),
    },
    {
        name: 'Golden Club',
        image: require(`./img/assets/Hands/Golden Club.png`),
    },
    {
        name: 'Gun Hands',
    ...
    {
        name: 'Kanabo',
        image: require(`./img/assets/Hands/Kanabo.png`),
    },
    {
        name: 'Katana',
    ...
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Hands/SantaHand.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Hands/No Hands.png`),
...
export const loadedHead: LoadedAttribute[] = [
    ...
    {
        name: 'Anubis',
        image: require(`./img/assets/Head/Anubis.png`),
    },
    {
        name: 'Army Helmet',
    ...
    {
        name: 'Half a Soul',
        image: require(`./img/assets/Head/Half a Soul.png`),
    },
    {
        name: 'Headdress',
        image: require(`./img/assets/Head/Headdress.png`),
    },
    {
        name: 'Headphones',
    ...
    {
        name: 'Roman Helmet',
        image: require(`./img/assets/Head/Roman Helmet.png`),
    },
    {
        name: 'Samurai',
    ...
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Head/SantaHat.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Head/SaviorHead.png`),
    },
    {
        name: 'Solana',
    ...
    {
        name: 'Spiked',
        image: require(`./img/assets/Head/Spiked.png`),
    },
    {
        name: 'Top Hat',
...
export const loadedMouth: LoadedAttribute[] = [
    ...
    {
        name: 'Cum Slug',
        image: require(`./img/assets/Mouth/CumMouth.png`),
    },
    {
        name: 'Cute',
    ...
    {
        name: 'Half Chapped',
        image: require(`./img/assets/Mouth/Half Chapped.png`),
    },
    {
        name: 'Happy',
    ...
    {
        name: 'Menpo',
        image: require(`./img/assets/Mouth/Menpo.png`),
    },
    {
        name: 'Mermaid',
    ...
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Mouth/SantaMouth.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Mouth/SaviorMouth.png`),
    },
    {
        name: 'Smug',
...
export const loadedSlug: LoadedAttribute[] = [
    {
        name: 'Beige',
    ...
    {
        name: 'Cum Slug',
        image: require(`./img/assets/Slug/CumSlug.png`),
    },
    {
        name: 'Cyan',
    ...
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Slug/SantaSlug.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Slug/SaviorSlug.png`),
    },
    {
        name: 'Shit',
...
export const loadedTail: LoadedAttribute[] = [
    ...
    {
        name: 'Cum Slug',
        image: require(`./img/assets/Tail/CumTail.png`),
    },
    {
        name: 'Dignified Loins',
        image: require(`./img/assets/Tail/Dignified Loins.png`),
    },
    {
        name: 'Manly Skirt',
        image: require(`./img/assets/Tail/Manly Skirt.png`),
    },
    {
        name: 'Mermaid Tail',
    ...
    {
        name: 'Rings and Cushion',
        image: require(`./img/assets/Tail/Rings and Cushion.png`),
    },
    {
        name: 'Santa Slug',
        image: require(`./img/assets/Tail/SantaTail.png`),
    },
    {
        name: 'Savior Slug',
        image: require(`./img/assets/Tail/No Tail.png`),
    ...
    {
        name: 'Slugazuri',
        image: require(`./img/assets/Tail/Slugazuri.png`),
    },
    {
        name: 'Snek',
        image: require(`./img/assets/Tail/Snek.png`),
    },
    {
        name: 'Tail Ring',
