...
var TextOnPath = /*#__PURE__*/function () {
  function TextOnPath(svgEl) {
    ...
    this.DOM.text = this.DOM.svg.querySelector('text'); // The textPath element

    this.DOM.textPath = this.DOM.text.querySelector('textPath'); // The path total length
...
var imagesLoaded = require('imagesloaded'); // Smooth scrolling for anchor links
